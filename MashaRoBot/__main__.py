...
PM_START_TEXT = """
Hello I'm 『Ｉｎｔｅｌ乛Ｃｏｒｅ』 ,
I AM MULTI TALENTED TELEGRAM BOT TO MANAGE GROUPS.[INTEL](https://telegra.ph/file/726a0d517edb00487a969.jpg)

➪ I am Intel Core a Project under Digital bot @RobotTech_official
...
HELP_STRINGS = """
INTEL CORE G7 comes with many special features in it!
CHECK ALL BUTTON BELOW TO EXPLORE EVERY COMMANDS OF Core™
𖣘 *All commands can either be used with* `/` *or* `!`.
𖣘 *If you facing any issue or find any bugs in any command then you can report it in @RobotTech_chat
"""
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Core is back with explosive features.✨")
        except Unauthorized:
            LOGGER.warning(
